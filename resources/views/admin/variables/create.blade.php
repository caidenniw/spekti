...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 style="font-size:24px;font-weight:700;">Tambah Variabel Baru</h1>
        <p style="font-size:14px;color:var(--on-surface-variant);">Tambahkan variabel penelitian baru ke dalam kuesioner.</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.variables.store') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="variable_name" class="form-control @error('variable_name') is-invalid @enderror"
                               placeholder="Contoh: ipk_status"
                               value="{{ old('variable_name') }}" required pattern="[a-z_]+">
                        @error('variable_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="urutan" class="form-control @error('urutan') is-invalid @enderror"
                               value="{{ old('urutan', $nextUrutan) }}" min="1" required style="max-width:100px;">
                        @error('urutan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="positif_value" class="form-control @error('positif_value') is-invalid @enderror mb-2"
                                   ...
                                   value="{{ old('positif_value') }}" required>
                            @error('positif_value')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <input type="text" name="positif_label" class="form-control @error('positif_label') is-invalid @enderror"
                                   placeholder="Label (contoh: Tinggi 3.51 - 4.00)"
                                   value="{{ old('positif_label') }}" required>
                            @error('positif_label')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="negatif_value" class="form-control @error('negatif_value') is-invalid @enderror mb-2"
                                   placeholder="Nilai (contoh: rendah)"
                                   value="{{ old('negatif_value') }}" required>
                            @error('negatif_value')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <input type="text" name="negatif_label" class="form-control @error('negatif_label') is-invalid @enderror"
                                   placeholder="Label (contoh: Rendah 2.76 - 3.50)"
                                   value="{{ old('negatif_label') }}" required>
                            @error('negatif_label')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary-custom">
                    <i class="bi bi-check-lg me-2"></i>Simpan Variabel
                </button>
